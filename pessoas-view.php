...
<div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                           <form method="post" class="form-horizontal" action="<?php echo HOME_URI.'/pessoas/salvar'; ?>">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Telefone</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" name="Telefone"></div>
                                </div>
